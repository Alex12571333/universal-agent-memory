...
- target evidence for identity-bound authorization and active-head semantics;
- target outage/recovery evidence for fail-soft recall and `/ready`;
- target concurrency/crash evidence for workspace-scoped reindex;
